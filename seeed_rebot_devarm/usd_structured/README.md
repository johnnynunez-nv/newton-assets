...
This asset was created with the [mujoco-usd-converter](https://github.com/newton-physics/mujoco-usd-converter) v0.4.0rc1 (commit [`75444a1`](https://github.com/newton-physics/mujoco-usd-converter/commit/75444a1f071e98955e7031d00449301b72f43509)), having converted the source MJCF from the MuJoCo Menagerie (`seeed_rebot_devarm/seeed_rebot_devarm.xml`, [PR #300](https://github.com/google-deepmind/mujoco_menagerie/pull/300), revision [`0cd5e4c`](https://github.com/johnnynunez/mujoco_menagerie/blob/0cd5e4cd5ea6b4fd684458c5dd918c93517821d8/seeed_rebot_devarm/seeed_rebot_devarm.xml) carrying the full link inertia tensors and explicit actuator `ctrlrange`). Aside from small manual edits applied per review (revolute-joint `newton:damping` converted to radians, `newton:selfCollisionEnabled = false` on the articulation root, and explicit `physics:staticFriction`), the conversion results are unchanged.
